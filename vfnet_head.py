...
class VFNetHead(ATSSHead, FCOSHead):
    ...
    def loss(self,
        ...
        #if len(epoch)%1 == 0 or len(epoch)==1:
        feature_target,noise_target = self.feature_map_target(featmap_sizes, gt_bboxes, all_level_points, img_shapes)
          #print(len(noise_target[0]))
    ...
    def feature_map_target(self, featmap_sizes, gt_bboxes, all_level_points, img_shapes):
